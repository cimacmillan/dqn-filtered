...
class ReplayBuffer(object):
    ...
    #Returns the frame to compare from the buffer from the current position
    def get_delta_reference_frame_from_current(self):
        start_idx = self.next_idx - self.frame_history_len
        return self.obs[start_idx]

    def memory_big_enough_for_delta_check(self):
        return self.num_in_buffer > self.frame_history_len
